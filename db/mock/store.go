...
func (m *MockStore) AddAccountBalance(ctx context.Context, arg sqlc.AddAccountBalanceParams) (sqlc.Accounts, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateEntry(ctx context.Context, arg sqlc.CreateEntryParams) (sqlc.Entries, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateTransfer(ctx context.Context, arg sqlc.CreateTransferParams) (sqlc.Transfers, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateUser(ctx context.Context, arg sqlc.CreateUserParams) (sqlc.Users, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountForUpdate(ctx context.Context, id int64) (sqlc.Accounts, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetUser(ctx context.Context, username string) (sqlc.Users, error) {
	m.ctrl.T.Helper()
